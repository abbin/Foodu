...
@interface AAPLCameraViewController () <AVCaptureFileOutputRecordingDelegate,PHPhotoLibraryChangeObserver,UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad
{
    ...
    [self.photoCollectionView registerNib:[UINib nibWithNibName:@"FImagePickerCollectionViewCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"FImagePickerCollectionViewCell"];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    return CGSizeMake(self.photoCollectionView.frame.size.height-self.photoCollectionView.frame.size.height/10,
                      self.photoCollectionView.frame.size.height-self.photoCollectionView.frame.size.height/10);
}
...
- (CGFloat)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout minimumLineSpacingForSectionAtIndex:(NSInteger)section {
    return self.photoCollectionView.frame.size.height/20;
}
